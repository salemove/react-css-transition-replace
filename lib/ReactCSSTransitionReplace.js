...
var ReactCSSTransitionReplace = (_temp2 = _class = function (_React$Component) {
  ...
  ReactCSSTransitionReplace.prototype.render = function render() {
    ...
    var activeHeightTransition = _state2.activeHeightTransition;
    ...
    var containerProps = _objectWithoutProperties(_props, ['overflowHidden', 'transitionName', 'changeWidth', 'component', 'transitionAppear', 'transitionEnter', 'transitionLeave', 'transitionAppearTimeout', 'transitionEnterTimeout', 'transitionLeaveTimeout']);
